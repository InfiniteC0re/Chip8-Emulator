...
public:
	...
	/* Sets new value for m_shouldUpdateScreen */
	inline void SetShouldUpdateScreen(bool new_state) { m_shouldUpdateScreen = new_state; };

	/* Returns true if should update screen */
	inline const bool& ShouldUpdateScreen() const { return m_shouldUpdateScreen; };
...
private:
	...
	bool m_shouldUpdateScreen = false;
	uint16_t m_opcode = 0;
